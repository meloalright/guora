...
func main() {
	...
	a0 := model.Answer{Content: `{"blocks":[{"key":"dpmcj","text":"Hello everyone, this is an example of answer.","type":"unstyled","depth":0,"inlineStyleRanges":[{"offset":62,"length":0,"style":"ITALIC"}],"entityRanges":[{"offset":62,"length":17,"key":0}],"data":{}},{"key":"fc5fr","text":"First of all, Guora is a self hosted web application based on community Q & A.","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}},{"key":"csb7o","text":"When you host the application, you can enjoy the Q & A platform and connect with your working partners. You can also archive your documents here.","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}},{"key":"eubjo","text":"If you're the administrator, you can go to the Admin Page to manage the application.","type":"unstyled","depth":0,"inlineStyleRanges":[{"offset":47,"length":10,"style":"ITALIC"}],"entityRanges":[{"offset":47,"length":10,"key":1}],"data":{}}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"href":"/question?id=1","title":"/question?id=1","url":"/question?id=1"}},"1":{"type":"LINK","mutability":"MUTABLE","data":{"href":"/admin","title":"/admin","url":"/admin"}}}}`, Type: 0, QuestionID: q0.ID, AnswerProfileID: p0.ID}
	a1 := model.Answer{Content: `{"blocks":[{"key":"frakc","text":"大家好，这是一个回答示例，可以解释我们的问题。","type":"unstyled","depth":0,"inlineStyleRanges":[{"offset":0,"length":0,"style":"BOLD"}],"entityRanges":[{"offset":23,"length":6,"key":0}],"data":{}},{"key":"3iau","text":"首先 Guora 是一个私有部署的社区问答系统。","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}},{"key":"e5nro","text":"在部署后你可以尽情使用该问答平台，并且和你的工作伙伴社交互动。你也可以在这里归档你的工作文档/学习文档。","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}},{"key":"7qiub","text":"如过你是管理员，你可以进入 管理页面 对系统进行管理。","type":"unstyled","depth":0,"inlineStyleRanges":[{"offset":14,"length":5,"style":"BOLD"}],"entityRanges":[{"offset":14,"length":4,"key":1}],"data":{}}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"href":"/question?id=1","title":"/question?id=1","url":"/question?id=1"}},"1":{"type":"LINK","mutability":"MUTABLE","data":{"href":"/admin","title":"/admin","url":"/admin"}}}}`, Type: 0, QuestionID: q1.ID, AnswerProfileID: p0.ID}
	a0.Create()
	a1.Create()
